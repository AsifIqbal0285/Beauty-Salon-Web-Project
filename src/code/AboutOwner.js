...
import aboutOwnerPhoto from '../images/photos/aboutOwnerBgPhoto.jpeg'
import ownerPhoto  from '../images/ownerPhoto.jpeg'
            ...
            <div className='sm:grid grid-cols-2 sm:p-24 '>
                <div className='sm:grid place-items-center'>
                    <div className='sm:mr-8'>
                        <h4 className='justify-self-center'>My name is <span className='text-green-500'>Kashee</span></h4><br></br>
                        <p className=''>
                            ...
                            come on down to <span className='text-green-500'>Beauty By kashee</span>!!
                        </p>
                    </div>
