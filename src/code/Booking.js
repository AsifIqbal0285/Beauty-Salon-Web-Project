        ...
        <div className='sm:order-first'> 
          <Dropdown className="mb-4">
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item onClick={()=>addStylestToItems('Kashaf')} id='Kashaf'>Kashaf</Dropdown.Item>
              <Dropdown.Item onClick={()=>addStylestToItems('Hina')} id='Hina'>Hina</Dropdown.Item>
              <Dropdown.Item onClick={()=>addStylestToItems('Maryaam')} id='Maryaam'>Maryaam</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
